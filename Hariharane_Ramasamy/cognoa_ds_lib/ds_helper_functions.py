...
'''
Comments entered by Hariharane Ramasamy begins
Problems : 
     1) name is not correct - change this to normalize_val 
     2) min/max are repeatedly found - good to find this values before itself  as <min/max>_<column_name>_<datastructure_name>
         repeatedly done  for all column values which will result in n logn (if the columns are sorted) or n ^ 2 if the columns are not
         sorted.
Comments entered by Hariharane Ramasamy ends
'''
...
Comments entered by Hariharane Ramasamy begins
Problems 
There is slight inefficiency here. 
  keyword.lower() need to be done only once. 
Comments entered by Hariharane Ramasamy ends
'''
...
''' 
Hariharane Ramasamy comment begins 
This is used to select a subset of data for training 
Hariharane Ramasamy comment ends 
'''
...
''' 
Hariharane Ramasamy comment begins 
Do not understand this now but may be later 
Hariharane Ramasamy comment ends 
'''
...
''' 
Hariharane Ramasamy comment begins 
any data modeling will require dependant varaibles (feature columns), target column (dependant variable) , 
feature encoding map and encoded features are used to tansform feature column for modeling 
Hariharane Ramasamy comment ends 
'''
...
''' 
Hariharane Ramasamy comment begins 
every  training data is used to test for validity
Hariharane Ramasamy comment ends 
'''
...
def getPrecisionDegradationFactors(metrics_worse, metrics_better, debug=False):
    ...
    if debug:
        ...
        print 'precision_degradation_factors: ', precision_degradation_factors
