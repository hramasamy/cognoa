...
Here v1 and v2 mappings is carried out not much to give. 
Straightforward except databse could be used to store these values and dataframe could be created  reading fhem from db. 
there reducing the code needed.
...
a    {'v1_key': 'ados2_d1', 'v2_key': 'ados2_d1', 'details_of_question_or_answer_changes': 'New answer code and significant clarifications',
        'v1_to_v2_answer_mapping': {'2': ['2','3']}, 'v2_to_v1_answer_mapping': {'3': '2'}},
